...
// in simulator we redefine to format for OnibusSjc Developer console
...
{\
	NSString * exceptionName = [@"org.onibussjc." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.onibussjc";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIOnibusSjcNativeItemNone = -1, 
	UIOnibusSjcNativeItemSpinner = -2,
	UIOnibusSjcNativeItemProgressBar = -3,
	
	UIOnibusSjcNativeItemSlider = -4,
	UIOnibusSjcNativeItemSwitch = -5,
	UIOnibusSjcNativeItemMultiButton = -6,
	UIOnibusSjcNativeItemSegmented = -7,
	
	UIOnibusSjcNativeItemTextView = -8,
	UIOnibusSjcNativeItemTextField = -9,
	UIOnibusSjcNativeItemSearchBar = -10,
	
	UIOnibusSjcNativeItemPicker = -11,
	UIOnibusSjcNativeItemDatePicker = -12,
	
	UIOnibusSjcNativeItemInfoLight = -13,
	UIOnibusSjcNativeItemInfoDark = -14,
	
	UIOnibusSjcNativeItemDisclosure = -15,
	
	UIOnibusSjcNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all OnibusSjc instances of
