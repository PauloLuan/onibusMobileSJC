...
@interface OnibusSjcObject : KrollCoverageObject {
#else
@interface OnibusSjcObject : KrollObject {
#endif
@private
...
extern NSString * OnibusSjc$ModuleRequireFormat;
