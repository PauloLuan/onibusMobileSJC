...
/**
 Base class for all OnibusSjc views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the OnibusSjc view hierarchy (such as wrapped iOS UIViews) was touched.
