 ...
 * Copyright (c) 2009-2011 by OnibusSjc, Inc. All Rights Reserved.
...
//@interface OnibusSjcObject : NSObject
//@end

@interface OnibusSjcObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[OnibusSjcObject class]])
		{
			for (NSString *key in [[(OnibusSjcObject*)o modules] allKeys])
			{
